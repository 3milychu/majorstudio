...
types<-table(unlist(costume_reclass$objectName))
print(types)
write.csv(types, file="types.csv")

cultures<-table(unlist(costume_reclass$Culture))
print(cultures)
...
suits <- subset(costume_reclass, objectName == "Suit")

table(suits$Culture)
hist(suits$objectBegin)
```
